...
# Webcam Setup
wCam, hCam = 640, 480
droidcam_url = "http://192.168.1.69:4747/video"
cam = cv2.VideoCapture(droidcam_url)
cam.set(3, wCam)
cam.set(4, hCam)

# Define Rectangle Parameters
rect_x, rect_y, rect_w, rect_h = 100, 100, 200, 200  # Rectangle position and size
...
with mp_hands.Hands(
    ...
    while cam.isOpened():
        ...
        if results.multi_hand_landmarks:
            ...
            if len(lmList) >= 2:  # Check if there are at least two landmarks detected
